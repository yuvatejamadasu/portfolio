...
export const portfolioData = {
  ...
  bio: "A dedicated Java Full Stack Developer building scalable, secure, and high-performance web applications from end to end.",
  detailedBio: "Hello! I am Madasu Yuva Teja, a passionate Java Full Stack Developer with extensive experience in building robust back-end systems and dynamic front-end interfaces. I specialize in crafting secure and scalable applications using Java, Spring Boot, Hibernate, and Microservices on the backend, combined with modern frontend technologies like React JS and Tailwind CSS.",
  email: "madasuyuvateja@gmail.com",
  phone: "+91-7075929719",
  location: "Machilipatnam, AP, India",
  skills: [
    { name: "Java & J2EE", desc: "Advanced Core Java, Multithreading, Streams API" },
    { name: "Spring Boot", desc: "REST APIs, Security, Spring Data JPA" },
    { name: "Microservices", desc: "API Gateway, Service Discovery, Config Server" },
    { name: "SQL & NoSQL", desc: "MySQL, PostgreSQL, Oracle, MongoDB" },
    { name: "React JS", desc: "Hooks, Redux, Context API, Modern UI" },
    { name: "DevOps & Tools", desc: "Git, Docker, Jenkins, Maven, AWS" }
  ],
  projects: [
    {
      id: 1,
